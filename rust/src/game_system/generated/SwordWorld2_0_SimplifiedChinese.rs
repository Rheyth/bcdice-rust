...
use super::SwordWorld2_0::{eval_specific_command, ZH_TEXT};
...
pub struct SwordWorld2_0_SimplifiedChinese;

impl GameSystem for SwordWorld2_0_SimplifiedChinese {
    fn id(&self) -> &'static str {
        "SwordWorld2.0:SimplifiedChinese"
    }
    fn name(&self) -> &'static str {
        "剑世界2.0"
    }
    fn sort_key(&self) -> &'static str {
        "国際化:Simplified Chinese:剑世界2.0"
    }
...
#[cfg(test)]
mod tests {
    /// `test/data/SwordWorld2_0_SimplifiedChinese.toml` の全ケースが通ること（共通ハーネス）。
    #[test]
    fn all_toml_cases_pass() {
        crate::game_system::test_support::assert_toml_cases_strict(
            "SwordWorld2.0:SimplifiedChinese",
            "SwordWorld2_0_SimplifiedChinese.toml",
            73,
        );
    }
}

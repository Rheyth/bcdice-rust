// i18n/KillDeathBusiness/ja_jp.yml から機械抽出した表データ。値は1文字も変えていない。
// `KillDeathBusiness.rs` から `include!` される。独立モジュールではない。

pub(crate) const JA_FUMBLE: &str = "ファンブル(判定失敗。【視聴率】が20％減少)";
pub(crate) const JA_SPECIAL: &str = "スペシャル(判定成功。【視聴率】が10％増加)";
pub(crate) const JA_JD_NAME: &str = "判定";
pub(crate) const JA_JD_WARN_OVER_TARGET: &str = "難易度が12以上はスペシャルのみ成功。";
pub(crate) const JA_JD_WARN_MIN_TARGET: &str = "難易度の最低は5。";
pub(crate) const JA_JD_WARN_OVER_FUMBLE: &str =
    "スペシャルを出すと必ず成功なので、ファンブル率は11とする。";
pub(crate) const JA_JD_OPTIONS: &str =
    "【難易度%{target}、補正%{modifier}、ファンブル率%{fumble}】";
pub(crate) const JA_JD_DICE_VALUE: &str = "出目(%{dice_value})";
pub(crate) const JA_JD_FUMBLE: &str = "出目が2なのでファンブル！(判定失敗。【視聴率】が20％減少)";
pub(crate) const JA_JD_SPECIAL: &str = "出目が12なのでスペシャル！(判定成功。【視聴率】が10％増加)";
pub(crate) const JA_JD_LESS_THAN_FUMBLE: &str =
    "出目がファンブル率以下なのでファンブル！(判定失敗。【視聴率】が20％減少)";
pub(crate) const JA_JD_FAILURE: &str = "達成値%{value}、難易度未満なので判定失敗！";
pub(crate) const JA_JD_SUCCESS: &str = "達成値%{value}、難易度以上なので判定成功！";
pub(crate) const JA_ST_NAME: &str = "シーン表";
pub(crate) const JA_ST_FORMAT: &str = "%{result1}%{result2}";
pub(crate) static JA_ST_TABLE1: &[(i64, &str)] = &[
    (11, "あなたが根城にしていた"),
    (12, "あなたの写真で壁が埋め尽くされた"),
    (13, "アナログテレビが山と積まれた"),
    (14, "ゴミで埋め尽くされた"),
...
pub(crate) static JA_ST_TABLE2: &[(i64, &str)] = &[
    (11, "オフィス"),
    (12, "祭壇"),
    (13, "スタジオ"),
    (14, "倉庫"),
...
pub(crate) const JA_NAME_NAME: &str = "万能命名表";
pub(crate) static JA_NAME_TABLE1: &[(i64, &str)] = &[
    (11, "アナログ"),
    (12, "イージー"),
    (13, "エターナル"),
    (14, "エレクトロ"),
...
pub(crate) static JA_NAME_TABLE2: &[(i64, &str)] = &[
    (11, "X"),
    (12, "アビス"),
    (13, "グレイブ"),
    (14, "ゴールド"),
...
pub(crate) static JA_NAME_TABLE3: &[(i64, &str)] = &[
    (11, "アーム"),
    (12, "アイ"),
    (13, "イヤー"),
    (14, "ウィング"),
...
pub(crate) const JA_EST_NAME: &str = "サービスシーン表";
pub(crate) const JA_EST_FORMAT: &str = "%{scene}「%{chosen}」を行う。";
pub(crate) const JA_EST_UNDRESSING_NAME: &str = "脱衣系サービスシーン表";
pub(crate) static JA_EST_UNDRESSING_ITEMS: &[&str] = &[
    "衣装の不調",
    "着替え",
    "脱衣麻雀",
    "入浴",
...
pub(crate) const JA_EST_VIOLENCE_NAME: &str = "暴力系サービスシーン表";
pub(crate) static JA_EST_VIOLENCE_ITEMS: &[&str] = &[
    "勝ったあとの暴力",
    "集団の暴力",
    "暴力をほのめかす会話",
    "負けた後の暴力",
...
pub(crate) const JA_EST_TRAVEL_NAME: &str = "旅行系サービスシーン表";
pub(crate) static JA_EST_TRAVEL_ITEMS: &[&str] = &[
    "移動機関の紹介",
    "地元の遊びの紹介",
    "地元の動物の紹介",
    "地元の宿の紹介",
...
pub(crate) const JA_EST_LOVE_NAME: &str = "恋愛系サービスシーン表";
pub(crate) static JA_EST_LOVE_ITEMS: &[&str] = &[
    "キスシーン",
    "恋に気付く",
    "恋に悩む",
    "デートシーン",
...
pub(crate) const JA_EST_EMOTION_NAME: &str = "感動系サービスシーン表";
pub(crate) static JA_EST_EMOTION_ITEMS: &[&str] = &[
    "家族の愛に気付く",
    "かっこいいことを言う",
    "失敗して落ち込む",
    "地元住民と触れ合う",
...
pub(crate) const JA_EST_OTHER_GENRE_NAME: &str = "別ジャンルサービスシーン表";
pub(crate) static JA_EST_OTHER_GENRE_ITEMS: &[&str] = &[
    "サイコサスペンス",
    "スペースオペラ",
    "童話",
    "ヒロイックファンタジー",
...
pub(crate) const JA_HSAT_NAME: &str = "ヘルスタイリスト罵倒表";
pub(crate) static JA_HSAT_ABUSE1: &[(i64, &str)] = &[
    (11, "汁まみれになった"),
    (12, "お爺ちゃんがこのまえ捨てた"),
    (13, "失敗メイクの"),
...
pub(crate) static JA_HSAT_ABUSE2: &[(i64, &str)] = &[
    (11, "アルマジロ"),
    (12, "イソギンチャク"),
    (13, "カメムシ"),
    (14, "カモノハシ"),
...
pub(crate) static JA_HSAT_PREFIX: &[&str] = &[
    "「まるで『",
    "「まるで『",
    "「まさに『",
    "「まさに『",
...
pub(crate) static JA_HSAT_SUFFIX: &[&str] = &[
    "』みたいよ！」",
    "』みたいだわ！」",
    "』じゃないの！」",
    "』ね。」",
...
pub(crate) const JA_EXT_NAME: &str = "エキストラ表";
pub(crate) static JA_EXT_TABLE1: &[(i64, &str)] = &[
    (11, "あなたの親友である"),
    (12, "あなたと恨んで付け狙っている"),
    (13, "いそがしく電話で話し込んでいる"),
    (14, "ころんで逃げ損ねた"),
...
pub(crate) static JA_EXT_TABLE2: &[(i64, &str)] = &[
    (11, "サラリーマン"),
    (12, "スポーツ選手"),
    (13, "チンピラ"),
    (14, "ドライバー"),
...
pub(crate) static JA_EXT_TABLE3: &[(i64, &str)] = &[
    (11, "怪しい箱の中から"),
    (12, "哀れな犠牲者を殺しながら"),
    (13, "牛に乗りつつ"),
    (14, "馬に乗りつつ"),
...
pub(crate) static JA_EXT_TABLE4: &[(i64, &str)] = &[
    (11, "愛らしく登場"),
    (12, "あざやかに登場"),
    (13, "あっさりと登場"),
    (14, "怪しく登場"),
...
pub(crate) const JA_RTT_S_FORMAT: &str = "「%<category_name>s」《%<skill_name>s》";
pub(crate) const JA_RTT_RTT_FORMAT: &str =
    "指定特技ランダム決定表(%<category_dice>d,%<row_dice>d) ＞ %<text>s";
pub(crate) const JA_RTT_RCT_FORMAT: &str =
    "指定特技分野ランダム決定表(%<category_dice>s) ＞ %<category_name>s";
pub(crate) const JA_RTT_CAT1_NAME: &str = "職業";
pub(crate) static JA_RTT_CAT1_SKILLS: &[&str] = &[
    "無職",
    "芸術家",
    "研究者",
    "家事手伝い",
...
pub(crate) const JA_RTT_CAT2_NAME: &str = "動作";
pub(crate) static JA_RTT_CAT2_SKILLS: &[&str] = &[
    "叫ぶ",
    "閃く",
    "斬る",
    "振る",
...
pub(crate) const JA_RTT_CAT3_NAME: &str = "小道具";
pub(crate) static JA_RTT_CAT3_SKILLS: &[&str] = &[
    "ピアス",
    "髪飾り",
    "銃",
    "ネックレス",
...
pub(crate) const JA_RTT_CAT4_NAME: &str = "衣装";
pub(crate) static JA_RTT_CAT4_SKILLS: &[&str] = &[
    "ネイキッド",
    "アウトドア",
    "エスニック",
    "ヒップホップ",
...
pub(crate) const JA_RTT_CAT5_NAME: &str = "情動";
pub(crate) static JA_RTT_CAT5_SKILLS: &[&str] = &[
    "愛",
    "喜び",
    "期待",
    "焦り",
...
pub(crate) const JA_RTT_CAT6_NAME: &str = "願望";
pub(crate) static JA_RTT_CAT6_SKILLS: &[&str] = &[
    "死", "復讐", "勝利", "支配", "獲得", "繁栄", "強化", "安全", "健康", "長寿", "生",
];
pub(crate) static JA_HST_ITEMS: &[&str] = &[
...
pub(crate) static JA_HST: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("履歴表", 1, 6, JA_HST_ITEMS);
pub(crate) static JA_DWT_ITEMS: &[&str] = &[
    "今の美しさを保ったまま死にたい。",
    "おもしろい死にかたをしてみたい。",
    "自殺する勇気がないので死にたい。",
    "死んだらどうなるのか見てみたい。",
...
pub(crate) static JA_DWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「死」", 1, 6, JA_DWT_ITEMS);
pub(crate) static JA_RWT_ITEMS: &[&str] = &[
    "家族を殺した犯人に復讐したい。",
    "自分より幸せな隣人に復讐したい。",
    "自分を裏切った友人に復讐したい。",
    "自分を捨てた恋人に復讐したい。",
...
pub(crate) static JA_RWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「復讐」", 1, 6, JA_RWT_ITEMS);
pub(crate) static JA_VWT_ITEMS: &[&str] = &[
    "かつて負けたライバルに勝利したい。",
    "倒したい有名人(故人)がいる。",
    "倒したい有名人がいる。",
    "特定の業界で一番の実力者になりたい。",
...
pub(crate) static JA_VWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「勝利」", 1, 6, JA_VWT_ITEMS);
pub(crate) static JA_PWT_ITEMS: &[&str] = &[
    "欲しいアイテムがある。",
    "欲しい生き物がいる。",
    "欲しい関係がある。",
    "欲しい親族がいる。",
...
pub(crate) static JA_PWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「獲得」", 1, 6, JA_PWT_ITEMS);
pub(crate) static JA_CWT_ITEMS: &[&str] = &[
    "支配したい人物集団がいる。",
    "支配したい地域がある。",
    "世界を征服したい。",
    "選挙で勝ちたい。",
...
pub(crate) static JA_CWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「支配」", 1, 6, JA_CWT_ITEMS);
pub(crate) static JA_FWT_ITEMS: &[&str] = &[
    "落ちぶれた一族を復権させたい。",
    "地元経済を活性化させたい。",
    "趣味のジャンルに人を集めたい。",
    "絶滅した生き物を復活させたい。",
...
pub(crate) static JA_FWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「繁栄」", 1, 6, JA_FWT_ITEMS);
pub(crate) static JA_IWT_ITEMS: &[&str] = &[
    "世界最強になりたい。",
    "世界で最も美しくなりたい。",
    "世界で最も賢くなりたい。",
    "世界で最も幸せになりたい。",
...
pub(crate) static JA_IWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「強化」", 1, 6, JA_IWT_ITEMS);
pub(crate) static JA_HWT_ITEMS: &[&str] = &[
    "完成させたい薬物がある。",
    "絶滅させたい病原菌がある。",
    "難病から回復させたい縁者がいる。",
    "難病から回復したい。",
...
pub(crate) static JA_HWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「健康」", 1, 6, JA_HWT_ITEMS);
pub(crate) static JA_SAWT_ITEMS: &[&str] = &[
    "穏やかな生活を送りたい。",
    "穏やかに暮らして欲しい人がいる。",
    "終わらせたい争いがある。",
    "事故で死なせてしまった人を復活させたい。",
...
pub(crate) static JA_SAWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「安全」", 1, 6, JA_SAWT_ITEMS);
pub(crate) static JA_LWT_ITEMS: &[&str] = &[
    "今の美しさを保ちたい。",
    "今の強さを保ちたい。",
    "子供が一人前になるまで死ねない。",
    "不老の体が欲しい。",
...
pub(crate) static JA_LWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「長寿」", 1, 6, JA_LWT_ITEMS);
pub(crate) static JA_EWT_ITEMS: &[&str] = &[
    "生きている実感が欲しい。",
    "今とは違う人生をやり直したい。",
    "死んでしまったので復活したい。",
    "死んでしまった人を復活させたい。",
...
pub(crate) static JA_EWT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("願い事表「生」", 1, 6, JA_EWT_ITEMS);
pub(crate) static JA_OSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_OSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「オカルト」", 1, 6, JA_OSPT_ITEMS);
pub(crate) static JA_FSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_FSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「家族」", 1, 6, JA_FSPT_ITEMS);
pub(crate) static JA_LOSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_LOSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「恋愛」", 1, 6, JA_LOSPT_ITEMS);
pub(crate) static JA_JSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_JSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「正義」", 1, 6, JA_JSPT_ITEMS);
pub(crate) static JA_TSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_TSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「修行」", 1, 6, JA_TSPT_ITEMS);
pub(crate) static JA_BSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_BSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「笑い」", 1, 6, JA_BSPT_ITEMS);
pub(crate) static JA_SOUL_ITEMS: &[&str] = &["100", "200", "200", "200", "300", "300"];
pub(crate) static JA_SOUL: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ソウル放出表", 1, 6, JA_SOUL_ITEMS);
pub(crate) static JA_STGT_ITEMS: &[&str] = &[
...
pub(crate) static JA_STGT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("汎用演出表", 1, 6, JA_STGT_ITEMS);
pub(crate) static JA_OHT_ITEMS: &[&str] = &[
...
pub(crate) static JA_OHT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("実際どうだったのか表", 1, 6, JA_OHT_ITEMS);
pub(crate) static JA_PCT1_ITEMS: &[&str] = &[
...
pub(crate) static JA_PCT1: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ヘルライオンタスク表", 1, 6, JA_PCT1_ITEMS);
pub(crate) static JA_PCT2_ITEMS: &[&str] = &[
...
pub(crate) static JA_PCT2: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ヘルクロウタスク表", 1, 6, JA_PCT2_ITEMS);
pub(crate) static JA_PCT3_ITEMS: &[&str] = &[
...
pub(crate) static JA_PCT3: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ヘルスネークタスク表", 1, 6, JA_PCT3_ITEMS);
pub(crate) static JA_PCT4_ITEMS: &[&str] = &[
...
pub(crate) static JA_PCT4: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ヘルドラゴンタスク表", 1, 6, JA_PCT4_ITEMS);
pub(crate) static JA_PCT5_ITEMS: &[&str] = &[
...
pub(crate) static JA_PCT5: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ヘルフライタスク表", 1, 6, JA_PCT5_ITEMS);
pub(crate) static JA_PCT6_ITEMS: &[&str] = &[
...
pub(crate) static JA_PCT6: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ヘルゴートタスク表", 1, 6, JA_PCT6_ITEMS);
pub(crate) static JA_PCT7_ITEMS: &[&str] = &[
...
pub(crate) static JA_PCT7: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("ヘルベアタスク表", 1, 6, JA_PCT7_ITEMS);
pub(crate) static JA_ANSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_ANSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「対悪魔」", 1, 6, JA_ANSPT_ITEMS);
pub(crate) static JA_MASPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_MASPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット「意地悪」", 1, 6, JA_MASPT_ITEMS);
pub(crate) static JA_MOSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_MOSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「金儲け」", 1, 6, JA_MOSPT_ITEMS);
pub(crate) static JA_PASPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_PASPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「仕切り」", 1, 6, JA_PASPT_ITEMS);
pub(crate) static JA_POSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_POSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「人気」", 1, 6, JA_POSPT_ITEMS);
pub(crate) static JA_UMSPT_ITEMS: &[&str] = &[
...
pub(crate) static JA_UMSPT: crate::dice_table::Table =
    crate::dice_table::Table::from_dice("サブプロット表「恨み」", 1, 6, JA_UMSPT_ITEMS);
pub(crate) static JA_CMT_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (11, crate::dice_table::TableItem::Text("あなたのＴシャツ／決めポーズの姿が背中にプリントされたＴシャツです。そして、フロントにはあの名台詞が！")),
    (12, crate::dice_table::TableItem::Text("あなたのアクションフィギュア／放送中から大人気！職人が一つ一つ入魂の手作り！夜になると、込められた魂が泣き叫びます。")),
    (13, crate::dice_table::TableItem::Text("ヘルーレイボックス／シーズン６６６の全てがここに……特典映像満載で送る、豪華ボックスセット！予約特典はヘルくんストラップです。")),
    (14, crate::dice_table::TableItem::Text("ヘルエアコン／これさえあれば、火事の最中でも気温は氷点下！逆に家を燃やすこともできますよ。温度調節機能は有料オプションです！")),
    (15, crate::dice_table::TableItem::Text("ヘルおむつ／ヘルギャザーで漏れをストップ、６６６年間履きっぱなしでも平気！中身がどうなるか保証しません、ヘルおむつ")),
    (16, crate::dice_table::TableItem::Text("ヘルサプリ／寝なくても平気！カラフルな幻覚が見える！でもメイン機能は健康増進です。ヘルサプリで健康生活を！")),
    (22, crate::dice_table::TableItem::Text("ヘルツアーズ／お得な料金で地獄百景を回ろう！苦しむ人間との魂の触れ合いが満載！ヘルツアーズでは、他社ではできない体験をお約束します。")),
    (23, crate::dice_table::TableItem::Text("ヘルテレビ／夜中に女性が出てきますが、気にしなければ大丈夫！アナログヘルテレビは政府の協賛を得ています。")),
    (24, crate::dice_table::TableItem::Text("ヘルビール／アルコール度数６６６％、ヘルホップ使用。地獄の渇きにはヘルビール……違いの分かる人のために。")),
    (25, crate::dice_table::TableItem::Text("ヘルフォン／ドヤ顔のノマド気取りをぶちのめすこともできます。そう、ヘルフォンならね。")),
    (26, crate::dice_table::TableItem::Text("ヘルまんじゅう／数千年のご愛顧をいただいております、地獄銘菓ヘルまんじゅう。うまい、ヘルうますぎる。しかしながら、食べると死にます。")),
    (33, crate::dice_table::TableItem::Text("ヘルモービル／人を轢けば轢くほど速くなり……走りは別次元へ。ヘルモービルが、お求めやすい価格で新登場。")),
    (34, crate::dice_table::TableItem::Text("ヘル会話教室／隣人をうまく罵れない？イヤな奴に言いくるめられた？ヘル会話を学べば、どんな相手も激昂させられます！")),
    (35, crate::dice_table::TableItem::Text("ヘル金融／金利６６６％の安心がここに。ヘル金融の取り立ては、非常に紳士的だと評判です。")),
    (36, crate::dice_table::TableItem::Text("ヘル汁(健康飲料)／辺獄で採れた新鮮な毒草を、そのまま粉末にしました。これを飲めば、もう病気や老化の心配はいりません。健康飲料ヘル汁。")),
    (44, crate::dice_table::TableItem::Text("ヘル整形外科／無保険かつ無免許ですが、どんな注文にも応えます。ヘル整形外科は、あなたのおっしゃる通りの外見を実現します！")),
    (45, crate::dice_table::TableItem::Text("ヘル生命保険／すぐ死ぬあなたに、ヘル生命の安全コース。残された人には地獄が待っています。")),
    (46, crate::dice_table::TableItem::Text("ヘル洗剤／どんなにしつこい血糊や汚物も一撃！どんな色の服も地獄の黒に染まります！ヘル洗剤、好評発売中！")),
    (55, crate::dice_table::TableItem::Text("ヘル洗濯機／６６６層式、音速を超えた回転があなたの衣装を粉々に！なにをしたかったのか忘れれば壮観です。ヘル洗濯機！")),
    (56, crate::dice_table::TableItem::Text("ヘル掃除機／好評の壁面粉砕機能に加えて、今年のモデルには屋根吸引機能も！ヘル掃除機のスイッチを入れるだけで、あなたの家がなくなります。")),
    (66, crate::dice_table::TableItem::Text("ヘル入浴剤／体が溶ける！新感覚で話題を呼んだヘル入浴剤がついに登場！死体の処理には使わないでください。")),
];
pub(crate) static JA_CMT: crate::dice_table::D66Table =
    crate::dice_table::D66Table::new("CM表", crate::enums::D66SortType::Asc, JA_CMT_ITEMS);
pub(crate) static JA_ERT_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (
        11,
        crate::dice_table::TableItem::Text("おいしそうな匂いがするようになった"),
    ),
    (
        12,
        crate::dice_table::TableItem::Text("おまけでヤギが出てきた"),
    ),
    (
        13,
        crate::dice_table::TableItem::Text("髪が蛍光色に変わった"),
    ),
    (
        14,
        crate::dice_table::TableItem::Text("声がロボっぽくなった"),
    ),
    (
        15,
        crate::dice_table::TableItem::Text("先が三角形になったシッポが生えた"),
    ),
    (
        16,
        crate::dice_table::TableItem::Text("頭上に謎のプログレスバーが出ている"),
    ),
    (22, crate::dice_table::TableItem::Text("性別が変わった")),
    (
        23,
        crate::dice_table::TableItem::Text("全身にモザイクがかかった"),
    ),
    (
        24,
        crate::dice_table::TableItem::Text("全体的に半透明になった"),
    ),
    (25, crate::dice_table::TableItem::Text("ちょっと腐った")),
    (
        26,
        crate::dice_table::TableItem::Text("肌が蛍光色に変わった"),
    ),
    (33, crate::dice_table::TableItem::Text("羽が生えた")),
    (
        34,
        crate::dice_table::TableItem::Text("番組参加中の記憶を失った"),
    ),
    (
        35,
        crate::dice_table::TableItem::Text("額に第三の目が開いた"),
    ),
    (36, crate::dice_table::TableItem::Text("微妙に浮いてる")),
    (44, crate::dice_table::TableItem::Text("ひよこにかわった")),
    (
        45,
        crate::dice_table::TableItem::Text("不合格品のスタンプを押された"),
    ),
    (46, crate::dice_table::TableItem::Text("太った")),
    (
        55,
        crate::dice_table::TableItem::Text("耳が好きな動物のものに変わった"),
    ),
    (56, crate::dice_table::TableItem::Text("痩せた")),
    (
        66,
        crate::dice_table::TableItem::Text("立派な角が額に生えた"),
    ),
];
pub(crate) static JA_ERT: crate::dice_table::D66Table =
    crate::dice_table::D66Table::new("蘇生副作用表", crate::enums::D66SortType::Asc, JA_ERT_ITEMS);
pub(crate) static JA_WKT_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (
        11,
        crate::dice_table::TableItem::Text("家を追い出されたヘルＰが泊まりに来た"),
    ),
    (
        12,
        crate::dice_table::TableItem::Text("危険なオーラを醸し出せるようになり、非常にモテた"),
    ),
    (
        13,
        crate::dice_table::TableItem::Text("地獄落ちを覚悟し、身辺整理を行った"),
    ),
    (
        14,
        crate::dice_table::TableItem::Text("地獄テレビ情報雑誌にインタビューを受けた"),
    ),
    (
        15,
        crate::dice_table::TableItem::Text("実家の商売が好調になるが、客がみんなヘルピープル"),
    ),
    (
        16,
        crate::dice_table::TableItem::Text(
            "信号待ちをしていたら、仕事中の悪魔にサインを求められた",
        ),
    ),
    (
        22,
        crate::dice_table::TableItem::Text("親戚が番組を見ていて、電話で感想を伝えてきた"),
    ),
    (
        23,
        crate::dice_table::TableItem::Text("次の週の護衛天使と知り合いになった"),
    ),
    (
        24,
        crate::dice_table::TableItem::Text("次の週の標的と知り合いになった"),
    ),
    (
        25,
        crate::dice_table::TableItem::Text("トラウマが残って全く眠れず、酒に溺れた"),
    ),
    (
        26,
        crate::dice_table::TableItem::Text("願いが叶うなら働かなくていいし、仕事を辞めた"),
    ),
    (
        33,
        crate::dice_table::TableItem::Text("願いとは別に出演報酬が振り込まれたので豪遊した"),
    ),
    (
        34,
        crate::dice_table::TableItem::Text("番組中のノリで人をはたいたら、なんだか死んでしまった"),
    ),
    (
        35,
        crate::dice_table::TableItem::Text("番組や悪魔が怖くなって世界中を逃げ回った"),
    ),
    (
        36,
        crate::dice_table::TableItem::Text("ファンを名乗るストーカーに自宅を荒らされた"),
    ),
    (
        44,
        crate::dice_table::TableItem::Text("ふと思い立って山に籠り、修行に明け暮れた"),
    ),
    (
        45,
        crate::dice_table::TableItem::Text("ヘルスタイリストに自宅の衣類をすべて燃やされた"),
    ),
    (
        46,
        crate::dice_table::TableItem::Text("ヘルドクターが借金の申し込みに来た"),
    ),
    (
        55,
        crate::dice_table::TableItem::Text("ヘルドレスの偽物を売りつけようとする下級悪魔と戦った"),
    ),
    (
        56,
        crate::dice_table::TableItem::Text("他の回収人のうち一人と同じ職場だったことが明らかに"),
    ),
    (
        66,
        crate::dice_table::TableItem::Text("妙に寄付を募る営業電話がかかってくる週だった"),
    ),
];
pub(crate) static JA_WKT: crate::dice_table::D66Table =
    crate::dice_table::D66Table::new("一週間表", crate::enums::D66SortType::Asc, JA_WKT_ITEMS);
pub(crate) static JA_PCDT_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (11, crate::dice_table::TableItem::Text("ヘルライオン")),
    (12, crate::dice_table::TableItem::Text("ヘルライオン")),
    (13, crate::dice_table::TableItem::Text("ヘルライオン")),
    (14, crate::dice_table::TableItem::Text("ヘルクロウ")),
    (15, crate::dice_table::TableItem::Text("ヘルクロウ")),
    (16, crate::dice_table::TableItem::Text("ヘルクロウ")),
    (22, crate::dice_table::TableItem::Text("ヘルスネーク")),
    (23, crate::dice_table::TableItem::Text("ヘルスネーク")),
    (24, crate::dice_table::TableItem::Text("ヘルスネーク")),
    (25, crate::dice_table::TableItem::Text("ヘルドラゴン")),
    (26, crate::dice_table::TableItem::Text("ヘルドラゴン")),
    (33, crate::dice_table::TableItem::Text("ヘルドラゴン")),
    (34, crate::dice_table::TableItem::Text("ヘルフライ")),
    (35, crate::dice_table::TableItem::Text("ヘルフライ")),
    (36, crate::dice_table::TableItem::Text("ヘルフライ")),
    (44, crate::dice_table::TableItem::Text("ヘルゴート")),
    (45, crate::dice_table::TableItem::Text("ヘルゴート")),
    (46, crate::dice_table::TableItem::Text("ヘルゴート")),
    (55, crate::dice_table::TableItem::Text("ヘルベア")),
    (56, crate::dice_table::TableItem::Text("ヘルベア")),
    (66, crate::dice_table::TableItem::Text("ヘルベア")),
];
pub(crate) static JA_PCDT: crate::dice_table::D66Table = crate::dice_table::D66Table::new(
    "製作委員決定表",
    crate::enums::D66SortType::Asc,
    JA_PCDT_ITEMS,
);
pub(crate) static JA_WOTA_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (11, crate::dice_table::TableItem::Text("医者")),
    (12, crate::dice_table::TableItem::Text("お嬢様")),
    (13, crate::dice_table::TableItem::Text("宇宙飛行士")),
    (14, crate::dice_table::TableItem::Text("メイド")),
    (15, crate::dice_table::TableItem::Text("教師")),
    (16, crate::dice_table::TableItem::Text("GM")),
    (22, crate::dice_table::TableItem::Text("小説家")),
    (23, crate::dice_table::TableItem::Text("ギャル")),
    (24, crate::dice_table::TableItem::Text("警察官")),
    (25, crate::dice_table::TableItem::Text("小学生")),
    (26, crate::dice_table::TableItem::Text("オカン")),
    (33, crate::dice_table::TableItem::Text("アイドル")),
    (34, crate::dice_table::TableItem::Text("マッチョ")),
    (35, crate::dice_table::TableItem::Text("バンドマン")),
    (36, crate::dice_table::TableItem::Text("魔法使い")),
    (44, crate::dice_table::TableItem::Text("超能力者")),
    (45, crate::dice_table::TableItem::Text("サラリーマン")),
    (46, crate::dice_table::TableItem::Text("メンヘラ")),
    (55, crate::dice_table::TableItem::Text("ゴリラ")),
    (56, crate::dice_table::TableItem::Text("ゾンビ")),
    (66, crate::dice_table::TableItem::Text("ロボット")),
];
pub(crate) static JA_WOTA: crate::dice_table::D66Table = crate::dice_table::D66Table::new(
    "単語表A(人物)",
    crate::enums::D66SortType::Asc,
    JA_WOTA_ITEMS,
);
pub(crate) static JA_WOTB_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (11, crate::dice_table::TableItem::Text("自動販売機")),
    (12, crate::dice_table::TableItem::Text("カードゲーム")),
    (13, crate::dice_table::TableItem::Text("お子様ランチ")),
    (14, crate::dice_table::TableItem::Text("冷蔵庫")),
    (15, crate::dice_table::TableItem::Text("ペット")),
    (16, crate::dice_table::TableItem::Text("駄菓子")),
    (22, crate::dice_table::TableItem::Text("サッカー")),
    (23, crate::dice_table::TableItem::Text("インターネット")),
    (24, crate::dice_table::TableItem::Text("ラーメン")),
    (25, crate::dice_table::TableItem::Text("法律")),
    (26, crate::dice_table::TableItem::Text("ミステリー")),
    (33, crate::dice_table::TableItem::Text("爆弾")),
    (34, crate::dice_table::TableItem::Text("電車")),
    (35, crate::dice_table::TableItem::Text("ロケット")),
    (36, crate::dice_table::TableItem::Text("パチンコ")),
    (44, crate::dice_table::TableItem::Text("スマートフォン")),
    (45, crate::dice_table::TableItem::Text("トイレ")),
    (46, crate::dice_table::TableItem::Text("カブトムシ")),
    (55, crate::dice_table::TableItem::Text("オーケストラ")),
    (56, crate::dice_table::TableItem::Text("プロレス")),
    (66, crate::dice_table::TableItem::Text("太陽")),
];
pub(crate) static JA_WOTB: crate::dice_table::D66Table =
    crate::dice_table::D66Table::new("単語表B(物)", crate::enums::D66SortType::Asc, JA_WOTB_ITEMS);
pub(crate) static JA_WOTC_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (11, crate::dice_table::TableItem::Text("スーパーマーケット")),
    (12, crate::dice_table::TableItem::Text("美容院")),
    (13, crate::dice_table::TableItem::Text("地獄")),
    (14, crate::dice_table::TableItem::Text("コンビニ")),
    (15, crate::dice_table::TableItem::Text("老人ホーム")),
    (16, crate::dice_table::TableItem::Text("居酒屋")),
    (22, crate::dice_table::TableItem::Text("コインランドリー")),
    (23, crate::dice_table::TableItem::Text("遊園地")),
    (24, crate::dice_table::TableItem::Text("電波塔")),
    (25, crate::dice_table::TableItem::Text("ダム")),
    (26, crate::dice_table::TableItem::Text("映画")),
    (33, crate::dice_table::TableItem::Text("運動会")),
    (34, crate::dice_table::TableItem::Text("お祭り")),
    (35, crate::dice_table::TableItem::Text("キャンプ")),
    (36, crate::dice_table::TableItem::Text("裁判所")),
    (44, crate::dice_table::TableItem::Text("駐車場")),
    (45, crate::dice_table::TableItem::Text("温泉")),
    (46, crate::dice_table::TableItem::Text("富士山")),
    (55, crate::dice_table::TableItem::Text("心霊スポット")),
    (56, crate::dice_table::TableItem::Text("レストラン")),
    (66, crate::dice_table::TableItem::Text("学校")),
];
pub(crate) static JA_WOTC: crate::dice_table::D66Table = crate::dice_table::D66Table::new(
    "単語表C(場所)",
    crate::enums::D66SortType::Asc,
    JA_WOTC_ITEMS,
);
pub(crate) static JA_VOT_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (11, crate::dice_table::TableItem::Text("発狂した")),
    (12, crate::dice_table::TableItem::Text("発明した")),
    (13, crate::dice_table::TableItem::Text("論破した")),
    (14, crate::dice_table::TableItem::Text("暴走した")),
    (15, crate::dice_table::TableItem::Text("逮捕した")),
    (16, crate::dice_table::TableItem::Text("演説した")),
    (22, crate::dice_table::TableItem::Text("敗北した")),
    (23, crate::dice_table::TableItem::Text("謝罪した")),
    (24, crate::dice_table::TableItem::Text("大損した")),
    (25, crate::dice_table::TableItem::Text("自慢した")),
    (26, crate::dice_table::TableItem::Text("脱獄した")),
    (33, crate::dice_table::TableItem::Text("借金した")),
    (34, crate::dice_table::TableItem::Text("目を覚ました")),
    (35, crate::dice_table::TableItem::Text("罪を犯した")),
    (36, crate::dice_table::TableItem::Text("料理をした")),
    (44, crate::dice_table::TableItem::Text("掃除をした")),
    (45, crate::dice_table::TableItem::Text("大事な物を紛失した")),
    (46, crate::dice_table::TableItem::Text("会社を設立した")),
    (55, crate::dice_table::TableItem::Text("駆け落ちした")),
    (56, crate::dice_table::TableItem::Text("寝落ちした")),
    (66, crate::dice_table::TableItem::Text("地獄落ちした")),
];
pub(crate) static JA_VOT: crate::dice_table::D66Table =
    crate::dice_table::D66Table::new("動詞表", crate::enums::D66SortType::Asc, JA_VOT_ITEMS);
pub(crate) static JA_LOT_ITEMS: &[(i64, crate::dice_table::TableItem)] = &[
    (11, crate::dice_table::TableItem::Text("東京特許許可局")),
    (12, crate::dice_table::TableItem::Text("デザートは別腹")),
    (13, crate::dice_table::TableItem::Text("行けたら行くね")),
    (14, crate::dice_table::TableItem::Text("東海道中膝栗毛")),
    (
        15,
        crate::dice_table::TableItem::Text("シェフの気まぐれサラダ"),
    ),
    (
        16,
        crate::dice_table::TableItem::Text("ニンニクヤサイアブラマシマシ"),
    ),
    (
        22,
        crate::dice_table::TableItem::Text("泣くよウグイス平安京"),
    ),
    (23, crate::dice_table::TableItem::Text("他人の不幸は蜜の味")),
    (24, crate::dice_table::TableItem::Text("ああ言えばこう言う")),
    (25, crate::dice_table::TableItem::Text("前回までのあらすじ")),
    (
        26,
        crate::dice_table::TableItem::Text("先生の次回作にご期待ください"),
    ),
    (
        33,
        crate::dice_table::TableItem::Text("酒は飲んでも飲まれるな"),
    ),
    (
        34,
        crate::dice_table::TableItem::Text("無料キャンペーン実施中"),
    ),
    (
        35,
        crate::dice_table::TableItem::Text("夕焼け小焼けのあかとんぼ"),
    ),
    (36, crate::dice_table::TableItem::Text("笑う門には福来る")),
    (44, crate::dice_table::TableItem::Text("思い立ったが吉日")),
    (45, crate::dice_table::TableItem::Text("墾田永年私財法")),
    (
        46,
        crate::dice_table::TableItem::Text("バナナはおやつに入りますか？"),
    ),
    (55, crate::dice_table::TableItem::Text("吾輩は猫である")),
    (
        56,
        crate::dice_table::TableItem::Text("あのイーハトーヴォの透き通った風"),
    ),
    (66, crate::dice_table::TableItem::Text("テーブルトークRPG")),
];
pub(crate) static JA_LOT: crate::dice_table::D66Table =
    crate::dice_table::D66Table::new("長め単語表", crate::enums::D66SortType::Asc, JA_LOT_ITEMS);
pub(crate) const JA_TOT_NAME: &str = "お題決定表";
pub(crate) const JA_TOT_ITEM1: &str = "%{one}を見て一言。";
pub(crate) const JA_TOT_ITEM2: &str =
    "この%{word1}、ひょっとして%{word2}かも、どうしてそう思った？";
pub(crate) const JA_TOT_ITEM3: &str = "%{verb}%{word}が言いそうなこと";
pub(crate) const JA_TOT_ITEM4: &str = "%{word1}が%{word2}になった世界ではどんなことが起こる？";
pub(crate) const JA_TOT_ITEM5: &str = "こんな%{word}は嫌だ。どんなの？";
pub(crate) const JA_TOT_ITEM6: &str = "%{long}みたいなことを言って下さい。";
pub(crate) const JA_OOT_NAME: &str = "〇〇を見て一言表";
pub(crate) const JA_OOT_ITEM1: &str = "ゲームマスターが最近撮ったor保存した写真";
pub(crate) const JA_OOT_ITEM3: &str = "ゲームマスターが用意した本やCDの表紙";
pub(crate) const JA_OOT_ITEM5: &str = "「%{word}」で検索して出てくる６番目の画像";
pub(crate) const JA_POT_NAME: &str = "ヘル司会者 リアクション表(好印象ver)";
pub(crate) const JA_POT_ITEM1: &str =
    "「良いセンスですねぇ。」\n会場に笑いが巻き起こる。\nうれしいね。座布団を%{size}枚与える。";
pub(crate) const JA_POT_ITEM2: &str = "「上手い！　一本取られました。」\n秀逸なジョークに視聴者たちの関心が深まったようだ。\n座布団を%{size}枚与える。";
pub(crate) const JA_POT_ITEM3: &str = "「案外こういう回答好きなんですよねぇ。ヘル山くん、座布団持って来て！」\nヘル司会者のツボにハマったようだ。\n座布団を%{size}枚与える。";
pub(crate) const JA_POT_ITEM4: &str = "「息ができない程笑っちゃいました、視聴者も何人か呼吸困難で倒れてます。\nウケ過ぎて大惨事になってしまった。\n座布団を%{size}枚与える。";
pub(crate) const JA_POT_ITEM5: &str = "はっはっは！　……おや？　ヘル山くんの機嫌が悪そうですが。」\n会場ではウケたようだが、ヘル山くんは気に入らなかったようだ。\n座布団を1枚没収する。";
pub(crate) const JA_POT_ITEM6: &str = "「いやぁ面白い回答でした！　座布団を差し上げます、いーちにーい……ところで今、視聴率何%でしたっけ？」\n視聴率の確認に乗じて座布団の枚数を誤魔化される。\n座布団の枚数を%{size}枚増減させる。";
pub(crate) const JA_NOT_NAME: &str = "ヘル司会者 リアクション表(不満ver)";
pub(crate) const JA_NOT_ITEM1: &str = "「は……は……はっくしょん！　あぁすみません、回答きいてませんでした。」\nどうやらくしゃみに気を取られてあなたの回答を聞いていなかったようだ。\n座布団の枚数に変化なし。";
pub(crate) const JA_NOT_ITEM2: &str = "「あなた普段から生真面目だって言われたりしません？」\n常識的すぎるあなたの言動はどうやらヘルピープルには響かなかったらしい。\n座布団を1枚没収する。";
pub(crate) const JA_NOT_ITEM3: &str = "「逆にこの空気感は面白いかも。」\nこれが滑り芸というやつか、一つ賢くなったぞ。\n座布団を%{size}枚与える。";
pub(crate) const JA_NOT_ITEM4: &str = "「ヘル級に面白くない回答をどうもありがとうございます。」\nヘル司会者からの皮肉だ、ヤな奴。\n座布団を%{size}枚没収する。";
pub(crate) const JA_NOT_ITEM5: &str = "「冗談でもそういうのはちょっと……」\nどうやらヘル司会者の肌感覚に合わなかったようだ。うむむ……\n座布団を%{size}枚没収する。";
pub(crate) const JA_NOT_ITEM6: &str = "「つまらないですねー。　ヘル山くん、一枚持っていって下さい！　……おや？　バグっちゃいました？」\n座布団がオーバーフローしたようだ。\n現在の座布団の枚数が255枚になる。";
